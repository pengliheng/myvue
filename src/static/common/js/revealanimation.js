...
window.RevealAnimation = (function(window, Waypoint, $) {
  ...
  RevealAnimation.prototype = {
    defaults: {
      mobile: true,
      repeat: true,
      resultClass: 'zy-anim-result',
      classPrefix: 'animated ',
      animationMarker: '.zy-having-animation',
      animationDataAttr: 'zy-animation'
    },
    ...
    animate: function(animation) {
      ...
      animation.animationFrame = window.requestAnimationFrame(function() {
